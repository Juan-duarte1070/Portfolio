    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-6 col-md-3">
                ...
                <ul class="list-unstyled small">
                    <li class="mb-2">
                        <a href="07april.php" class="text-secondary text-decoration-none" data-es="Tema Controversial" data-en="Controversial Topic">Nombre del proyecto 1</a>
                    </li>
                    <li class="mb-2">
                        <a href="20april.php" class="text-secondary text-decoration-none" data-es="Ciudad y Famoso" data-en="City And Famous">Nombre del proyecto 2</a>
                    </li>
                    <li class="mb-2">
                        <a href="02July.php" class="text-secondary text-decoration-none" data-es="Sincronización Labial" data-en="Lip Syncing">Nombre del proyecto 3</a>
                    </li>
                    <li class="mb-2">
                        <a href="27july.php" class="text-secondary text-decoration-none" data-es="Video Juego" data-en="Video Game">Nombre del proyecto 4</a>
                    </li>
                    <li class="mb-2">
                        <a href="10august.php" class="text-secondary text-decoration-none" data-es="Menú" data-en="Menu">Nombre del proyecto 5</a>
                    </li>
                    <li class="mb-2">
                        <a href="18august.php" class="text-secondary text-decoration-none" data-es="Hoja de Vida" data-en="Curriculum Vitae">Nombre del proyecto 6</a>
                    </li>
                    <li class="mb-2">
            ...
            <div class="col-6 col-md-3">
                ...
                <ul class="list-unstyled small">
                    <li class="mb-2"><a href="../index.html#home" class="text-secondary text-decoration-none" data-es="Inicio" data-en="Home">Inicio</a></li>
                    ...
                    <li class="mb-2"><a href="../index.html#trabajos" class="text-secondary text-decoration-none" data-es="Proyectos" data-en="Projects">Proyectos</a></li>
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2 text-center">
            ...
            <div class="d-flex gap-3 small">
                <a href="../index.html#home" class="text-secondary text-decoration-none" data-es="Inicio" data-en="Home">Inicio</a>
                <a href="../index.html#trabajos" class="text-secondary text-decoration-none" data-es="Proyectos" data-en="Projects">Proyectos</a>
                <a href="../index.html#contac" class="text-secondary text-decoration-none" data-es="Contacto" data-en="Contact">Contacto</a>
            </div>
        </div>
