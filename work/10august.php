...
<header class="py-5 mb-5 rounded-bottom-5 position-relative overflow-hidden shadow-lg border-bottom">
  ...
  <div class="container text-center position-relative z-1 py-3">
    <span class="badge bg-info bg-gradient text-dark px-3 py-2 rounded-pill mb-3 fw-bold shadow-sm d-inline-flex align-items-center" data-es="Presentación de Documento" data-en="Document Presentation">
      <i class="bi bi-file-earmark-pdf me-1"></i> Presentación de Documento
    </span>
    
    <h1 class="display-4 fw-black mb-3 tracking-tight" data-es="Menú Savors Of The House" data-en="Savors Of The House Menu">
      Menú Savors Of The House
    </h1>
    
    <p class="lead text-muted mb-0 max-w-xl mx-auto fw-normal" 
       data-es="El archivo PDF titulado 'Savors Of The House.pdf' es la presentación del menú para un restaurante gastronómico." 
       data-en="The PDF titled 'Savors Of The House.pdf' is the menu presentation for a culinary restaurant.">
      El archivo PDF titulado 'Savors Of The House.pdf' es la presentación del menú para un restaurante gastronómico.
    </p>
  </div>
</header>

<!-- Visor principal del documento -->
    ...
    <div class="col-lg-11 col-xl-10">
      ...
      <div class="card border-0 rounded-4 shadow-lg overflow-hidden">
        ...
        <div class="card-header border-bottom p-3 p-md-4 d-flex justify-content-between align-items-center">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <h2 class="h5 fw-bold mb-0" data-es="Menú Savors Of The House" data-en="Savors Of The House Menu">
                Menú Savors Of The House
              </h2>
            </div>
          </div>

          <a href="../Document/Savors Of The House.pdf" target="_blank" class="btn btn-gradient btn-sm px-3 rounded-pill shadow btn-hover-grow fw-semibold">
        ...
        <div class="d-md-none text-center p-3 border-top">
          <p class="small text-muted mb-2" data-es="¿Problemas para ver el menú en tu teléfono?" data-en="Having trouble viewing the menu on your phone?">
            ¿Problemas para ver el menú en tu teléfono?
          </p>
          <a href="../Document/Savors Of The House.pdf" target="_blank" class="btn btn-gradient btn-sm w-100 rounded-pill fw-semibold">
